...
class InnerJobDeciderTest {
  ...
  @CsvSource(
      ...
      delimiterString = "|")
  void shouldReturnExpectedJob(String innerJobValue, String expectedJob) {
    String innerJob = "EMPTY".equals(innerJobValue) ? "" : innerJobValue.trim();

    when(jobParameters.getString("innerJob")).thenReturn(innerJob);
