                ...
                """
                        WITH parametres AS (
                           ...
                           DO UPDATE SET
                               ...
                               prix_median =
                                   EXCLUDED.prix_median,

                               prix_m2 =
                                   EXCLUDED.prix_m2,

                               nombre_transactions =
                                   EXCLUDED.nombre_transactions,

                               prix_moyen_n_1 =
                                   EXCLUDED.prix_moyen_n_1,

                               prix_median_n_1 =
                                   EXCLUDED.prix_median_n_1,

                               prix_m2_n_1 =
                                   EXCLUDED.prix_m2_n_1,

                               nombre_transactions_n_1 =
                                   EXCLUDED.nombre_transactions_n_1,

                               variation_prix_moyen_pct =
                                   EXCLUDED.variation_prix_moyen_pct,

                               variation_prix_median_pct =
                                   EXCLUDED.variation_prix_median_pct,

                               variation_prix_m2_pct =
                                   EXCLUDED.variation_prix_m2_pct,

                               variation_nombre_transactions_pct =
                                   EXCLUDED.variation_nombre_transactions_pct,

                               date_debut_periode_n =
                                   EXCLUDED.date_debut_periode_n,

                               date_fin_periode_n =
                                   EXCLUDED.date_fin_periode_n,

                               date_debut_periode_n_1 =
                                   EXCLUDED.date_debut_periode_n_1,

                               date_fin_periode_n_1 =
                                   EXCLUDED.date_fin_periode_n_1,
