...
public class NestedJobStepListener implements StepExecutionListener {
  ...
  public ExitStatus afterStep(StepExecution stepExecution) {
    final String nameCode = "nameCode";
    stepExecution.getJobExecution().getExecutionContext().putString("code", "202");
    stepExecution
        .getJobExecution()
        .getExecutionContext()
        .putString(nameCode, "Nouvelle exécution acceptée et démarrée");
    for (Throwable exception : stepExecution.getJobExecution().getAllFailureExceptions()) {
      ...
      if (exception instanceof JobInstanceAlreadyCompleteException) {
        ...
        stepExecution
            .getJobExecution()
            .getExecutionContext()
            .putString(nameCode, "JobInstanceAlreadyCompleteException");
      }
      ...
      if (exception instanceof JobExecutionAlreadyRunningException) {
        ...
        stepExecution
            .getJobExecution()
            .getExecutionContext()
            .putString(nameCode, "JobExecutionAlreadyRunningException");
      }
    }
